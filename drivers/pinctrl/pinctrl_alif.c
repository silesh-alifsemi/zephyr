...
#define ALIF_GET_PORT(pin_cfg)		(((pin_cfg) >> ALIF_PORT_NUM_SHIFT) & ALIF_PORT_NUM_MASK)
#define ALIF_GET_PIN(pin_cfg)		(((pin_cfg) >> ALIF_PIN_NUM_SHIFT) & ALIF_PIN_NUM_MASK)
#define ALIF_GET_FUNC(pin_cfg)		((pin_cfg) & ALIF_PIN_FUNC_MASK)
#define ALIF_GET_PAD_CONFIG(pin_cfg)	(((pin_cfg) >> ALIF_PAD_CONFIG_SHIFT) & ALIF_PAD_CONFIG_MASK)
...
#define ALIF_IS_LPGPIO_PIN(pin_cfg)	(ALIF_GET_PORT(pin_cfg) == ALIF_LPGPIO_PORT_NUM)
