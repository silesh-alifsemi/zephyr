...
#define ALIF_CLK_CFG(module, reg, en_bit, en_mask, src, src_mask, src_bit, parent_clk) \
	...
	(((parent_clk) & ALIF_CLOCK_PARENT_CLK_MASK) <<                        \
			ALIF_CLOCK_PARENT_CLK_SHIFT))
...
#define ALIF_CLKCTL_PER_MST_MODULE	0x1U  /**< Peripheral Master Clock Control */
#define ALIF_CLKCTL_PER_SLV_MODULE	0x2U  /**< Peripheral Slave Clock Control */
